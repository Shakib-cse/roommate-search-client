    ...
    return (
      ...
      <div className="flex flex-wrap justify-center items-center gap-8">
        <div className="bg-base-100 p-8 rounded-2xl w-64 text-left shadow-md">
          <img width={50} height={50} src="/icon-posts.png" alt="Posts" />
        ...
        <div className="bg-base-100 p-8 rounded-2xl w-64 text-left shadow-md">
          <img width={50} height={50} src="/icon-users.png" alt="Users" />
          <strong className="text-4xl my-2 block">
        ...
        <div className="bg-base-100 p-8 rounded-2xl w-64 text-left shadow-md">
          <img width={50} height={50} src="/icon-matches.png" alt="Matches" />
          <strong className="text-4xl my-2 block">
        ...
        <div className="bg-base-100 p-8 rounded-2xl w-64 text-left shadow-md">
          <img width={50} height={50} src="/icon-feedback.png" alt="Reviews" />
          <strong className="text-4xl my-2 block">
